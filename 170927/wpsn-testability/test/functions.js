...
describe('functions', function () {
  ...
  describe('mulSync', function() {
    it('곱셈 기능', function(){
      const result = mulSync(2,2)
      assert.equal(result, 4)
    })
  })

  describe('addSync', function() {
    it('동기 덧셈 기능', function() {
  ...
  describe('addAsync', function() {
    ...
    it('비동기 덧셈 기능 (done)', function(done) {
      addAsync(1, 2)
        .then(result => {
          assert.equal(result, 3)
          done()
  ...
  describe('mulAsycn', function() {
    it('비동기 곱셈 기능(done)', function(done) {
      mulAsync(2, 2)
        .then(result => {
          assert.equal(result, 4)
          done()
    ...
    it('기본 기능 (async/await)', async function() {
      const result = await mulAsync(2, 2)
      assert.equal(result, 4)
    })
  })
